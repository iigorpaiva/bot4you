<template lang='pug'>
  .contain.py2
    h3.txt--center.my2 Market watchers
    .text(v-if='!watchers.length')
    p.txt--center.my2 You don't have any market watchers.
    ...
    h3.txt--center.my2 Strat runners
    .text(v-if='!stratrunners.length')
    p.txt--center.my2 You don't have any stratrunners.
    ...
    .hr
    h2.txt--center.my2 Start a new live B4Y
    .txt--center.my
      router-link.btn.btn-primary.btn-xl(to='/live-gekkos/new') Start live B4Y!
</template>
