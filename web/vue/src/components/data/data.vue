<template lang='pug'>
  .contain
    .text(v-html='intro')
    .hr
    h2.txt--center.my2.font-weight-bold Available datasets
    .txt--center.my2(v-if='datasetScanstate === "idle"')
      a.btn.btn-primary.btn-xl(href='#', v-on:click.prevent='scan') Scan available data
    ...
    .my2
      h2.txt--center.my2.font-weight-bold Import more data
      p.txt--center.my2Import more data You can easily import more market data directly from exchanges using the importer.
      .txt--center.my2 
        router-link.btn.btn-primary.btn-xl(to='/data/importer') Go to the importer!
</template>
